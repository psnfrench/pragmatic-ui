...
const slider_1: React.FC = () => {
  return (
    <svg width="332" height="216" viewBox="0 0 332 216" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M0 12C0 5.37258 5.37258 0 12 0H320C326.627 0 332 5.37258 332 12V175.751C332 182.378 326.627 187.751 320 187.751H204.239C201.496 187.751 198.836 188.69 196.702 190.413L172.762 209.735C168.263 213.366 161.814 213.273 157.422 209.513L135.369 190.634C133.195 188.773 130.427 187.751 127.565 187.751H12C5.37258 187.751 0 182.378 0 175.751V12Z"
        fill="#E9F4FE"
      />
