...
import { menuItemType, PComplexFilter } from './PComplexFilter';
...
const options: menuItemType[] = [
  {
    ...
    children: [
      { text: 'Vehicle', children: [{ text: 'Car' }, { text: 'Truck' }, { text: 'Ute' }] },
      { text: 'Bike', children: [{ text: 'Mountain Bike' }, { text: 'Downhill Bike' }, { text: 'E-Bike' }] },
    ],
  },
  { text: 'Sport', children: [{ text: 'Rugby' }, { text: 'Football' }, { text: 'Basketball' }] },
  { text: 'Education', children: [{ text: 'Primary' }, { text: 'Secondary' }, { text: 'Tertiary' }] },
  { text: 'Hobbies', children: [{ text: 'Guitar' }, { text: 'Hiking' }, { text: 'Reading' }] },
  { text: 'Social', children: [{ text: 'People' }] },
  {
    text: 'Travel',
    children: [
      { text: 'Countries', children: [{ text: 'South Africa' }, { text: 'France' }, { text: 'New Zealand' }] },
      {
        text: 'Activities',
...
const ComplexFilterDemo = () => {
  ...
  const handleSelected = (event: React.MouseEvent<HTMLLIElement>, key: string, parentMenuItemType?: menuItemType) => {
    ...
    setCurrentFilters((currentFilters) => [...currentFilters, parentMenuItemType]);
  ...
  const handleDelete = (filter: string) => {
    setCurrentFilters((prev) => prev.filter((i) => i.text !== filter));
  };
      ...
      <>
        ...
        {currentFilters.map((filter, key) => (
          <Chip
            ...
            variant="outlined"
            onClick={handleClick}
            onDelete={() => handleDelete(filter.text)}
          />
        ))}
